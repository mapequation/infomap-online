...
# relative codelength savings 9.22792%`}
      ...
      <p>
        ...
        network flows, including memory, multilayer, and sparse memory
        networks, is therefore straightforward. The only difference is at the
        finest level (
      ...
      <p>
        ...
        overlapping modules. In the state-level output, however, each state
        node belongs to exactly one module.
      </p>
      ...
      <p>
        ...
        the modules within each level are sorted by the total flow (PageRank)
        of the nodes they contain.
      </p>
      <p>
      ...
      <p>
        ...
        file is saved with the extension <code>.ftree</code>. It starts with
        the node hierarchy in tree format, followed by links formatted as:
      </p>
      ...
      <p>
        ...
        and child nodes within each module is also included in the module
        header line, as defined in the commented line above.
      </p>
