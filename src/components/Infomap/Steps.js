    ...
    <Step.Group fluid widths={3}>
      <Step completed={firstCompleted} active={firstActive}>
        ...
        <Step.Content>
          ...
          <Step.Description>Edit network or load file</Step.Description>
        </Step.Content>
      </Step>
      ...
      <Step completed={secondCompleted} active={secondActive}>
        ...
        <Step.Content>
          ...
          <Step.Description>Toggle parameters or add arguments</Step.Description>
        </Step.Content>
      </Step>
      ...
      <Step completed={thirdCompleted} active={thirdActive}>
        ...
        <Step.Content>
          ...
          <Step.Description>
            Save result or open in <span className="brand brand-nn">Network Navigator</span>
          </Step.Description>
        </Step.Content>
      </Step>
    </Step.Group>
